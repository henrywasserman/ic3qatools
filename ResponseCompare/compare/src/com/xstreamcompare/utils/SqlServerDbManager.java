...
public class SqlServerDbManager extends DatabaseManager {
	...
	public SqlServerDbManager(Properties props) throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException {
		super(props);
	}

	public java.sql.Timestamp getDatabaseTimeStamp() throws SQLException {
