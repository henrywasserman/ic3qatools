...
public class PostImage extends Request {
	...
	static Logger logger = Logger.getLogger(PostImage.class);
	Integer TestNumber = null;
	static int testnumber = 0;

	public PostImage(TestCase test) {
		super(test);
	}
	...
	public void makeRequests() throws Exception {
		...
		if (test.getRequests().size() == 2) {
			...
			variables = utils.extractVariablesFromRequest(postImageUrl);
		...
		postImageUrl = utils.compensateForF5(postImageUrl);
