...
public class GetMini extends Request {

  static Logger logger = Logger.getLogger(GetMini.class);
  Integer TestNumber = null;

  public GetMini(TestCase test) {
	  super(test);
  }
  ...
  public void makeRequests() throws Exception {
    ...
    url1.append( props.getProperty("mini-protocol") + 
    ...
    Assert.assertTrue( "Status: "+ response.getStatusLine().getStatusCode()+" The request "+url1+" was not successful",response.getStatusLine().getStatusCode()<300);
